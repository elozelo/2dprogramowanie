...
void task1()
{
    ...
    std::cout << "Liczba 1: " << count1.getValue() << "\n";
    std::cout << "Liczba 2: " << count2.getValue() << "\n";

    count1.deduct(2);
    count2.add(8);

    std::cout << "Liczba 1 po dalszych operacjach : " << count1.getValue() << "\n";
    std::cout << "Liczba 2 po dalszych operacjach : " << count2.getValue() << "\n";
}
